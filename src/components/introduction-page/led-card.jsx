...
import style from "../../styles/led-card.module.css";
    ...
    <>
      ...
      <div className={style.container}>
        ...
        <div className={style.box1}>
          <h2>
            Led by Ike Eze — Fintech Investor, Serial Founder & Startup Advisor
          </h2>
        </div>
        ...
        <div className={style.buttonDiv}>
          <p>
            Now, Ike’s proven system is yours—so you can stop dreaming and start
            building.
          </p>
        </div>
      </div>
